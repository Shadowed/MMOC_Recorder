...
Recorder.L = {
	...
	["An error happened while Recorder was serializing your data, please report the above error. You might have to scroll up to see it all."] = "An error happened while Recorder was serializing your data, please report the above error. You might have to scroll up to see it all.",
